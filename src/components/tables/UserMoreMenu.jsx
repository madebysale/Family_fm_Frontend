...
export default function UserMoreMenu({ props }) {
  ...
  const deleterow = () => {
    const Livechaturl = `http://192.168.29.199:3000/api/admin/deleteProduct`;
    axios
      .post(
        Livechaturl,
        {
  ...
  const [proudctimage, setproudctimage] = useState();
  const handleClickOpen2 = () => {
    setOpen2(true);
    const Livechaturl = `http://192.168.29.199:3000/api/admin/ProductsImage`;
    axios
      .post(
        Livechaturl,
        {
      ...
      .then((response) => {
        const outlook = response;
        setproudctimage(outlook.data.data.proudctimage.image);
      });
  };
  ...
  return (
    <>
      ...
      >
        <MenuItem component={RouterLink} to={`/Product/Productdetail/${props.id}`}>
          <ListItemIcon>
        ...
        <MenuItem
          ...
          to={`/Product/Editproduct/${props.id}`}
      ...
      <div>
        ...
        >
          ...
          <DialogActions1>
            <Button onClick={deleterow} className={classes.bt6}>
              Yes I'am Sure
            </Button>
        ...
        <Dialog open={open2} onClose={handleClose2}>
          ...
          <MuiDialogContent>
            <img src={proudctimage} style={{ width: '100%' }} />
          </MuiDialogContent>
        </Dialog>
